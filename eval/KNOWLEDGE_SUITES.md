...
```sh
python3 eval/prepare_mmlu.py --download
python3 eval/prepare_knowledge.py mmlu-pro --download --output eval/data/mmlu-pro.jsonl
python3 eval/prepare_knowledge.py codemmlu-full --download --output eval/data/codemmlu-full.jsonl
python3 eval/prepare_knowledge.py cybermetric --download --output eval/data/cybermetric.jsonl
python3 eval/prepare_knowledge.py secqa-v1 --download --output eval/data/secqa-v1.jsonl
python3 eval/prepare_knowledge.py secqa-v2 --download --output eval/data/secqa-v2.jsonl
python3 eval/prepare_knowledge.py metatool-awareness --download --output eval/data/metatool-awareness.jsonl
```
